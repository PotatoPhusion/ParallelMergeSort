...
public class OldParallelMergeSorter<E> extends RecursiveAction {
	...
	public OldParallelMergeSorter(E[] a, Comparator<? super E> comp, int maxThreads) {
    	...
    	if (this.maxThreads != maxThreads) {
    		...
    		this.availableThreads = maxThreads + 1;
    	}
    	this.a = (Integer[])a;
     ...
     */
    @SuppressWarnings("unchecked")
	public OldParallelMergeSorter(E[] a, int from, int to, Comparator<? super E> comp, int maxThreads) {
    ...
    private <E> void parallelMergeSort(E[] a, int from, int to,
        ...
        if (availableThreads <= 1) {
	        ...
	        OldParallelMergeSorter taskA = new OldParallelMergeSorter(a, from, mid, comp, maxThreads);
	        OldParallelMergeSorter taskB = new OldParallelMergeSorter(a, mid + 1, to, comp, maxThreads);
